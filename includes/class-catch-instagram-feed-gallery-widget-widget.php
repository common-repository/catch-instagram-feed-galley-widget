...
class Catch_Instagram_Feed_Gallery_Widget_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" value="<?php echo esc_attr( $instance['username'] ); ?>" class="widefat catch-instagram-feed-gallery-widget-username" />
		</p>
		<span class="show-more button" style="">More Options<i class="dashicons dashicons-arrow-down"></i></span>
